...
export const INITIAL_VELD_ASSESSMENTS: VeldAssessment[] = [
    ...
    { id: 'VA004', habitatZoneId: 'H01', date: getPastDate(395), speciesComposition: 8, basalCover: 8, soilErosion: 4, condition: 'Good', forageUtilization: 'Light', isFixedPointSite: true, photoUrl: 'https://images.unsplash.com/photo-1628583421338-1644